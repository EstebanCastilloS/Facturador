<div class="box-body row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" step="any" name="utility" value="{{ old('utility', $category->utility ?? '') }}" class="form-control" placeholder="Utilidad">
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" step="any" name="iva" value="{{ old('iva', $category->iva ?? '') }}" class="form-control" placeholder="Iva">
        </div>
    </div>
